if(!require(redcapAPI)) {
  install.packages("redcapAPI"); require(redcapAPI)}
...
err <- data.frame(recs$record_id,
                  ...
                  recs$mod_did_face,
                  sites,
                  recs$site_rstrcn_byc_deid,
                  recs$site_rstrcn_cam_deid,
                  recs$site_rstrcn_cho_deid,
                  recs$site_rstrcn_ebh_deid,
                  recs$site_rstrcn_hgh_deid,
                  recs$site_rstrcn_hhs_deid,
                  recs$site_rstrcn_lhr_deid,
                  recs$site_rstrcn_lhs_deid,
                  recs$site_rstrcn_mcm_deid,
                  recs$site_rstrcn_mcu_deid,
                  recs$site_rstrcn_pch_deid,
                  recs$site_rstrcn_pkh_deid,
                  recs$site_rstrcn_qns_deid,
                  recs$site_rstrcn_sbh_deid,
                  recs$site_rstrcn_sjh_deid,
                  recs$site_rstrcn_smh_deid,
                  recs$site_rstrcn_tbr_deid,
                  recs$site_rstrcn_tgh_deid,
                  recs$site_rstrcn_toh_deid,
                  recs$site_rstrcn_twh_deid,
                  recs$site_rstrcn_uot_deid,
                  recs$site_rstrcn_uow_deid,
